$(document).ready(function () {
    ...
    var infoBtn = L.easyButton({
        states: [{
            stateName: 'fa-info',
            icon: '<img src="images/info.jpeg" style="width:1.2em;height: 1.2em; margin-top:4px">',
            title: 'Show Info',
    ...
    var weatherBtn = L.easyButton({
        states: [{
            ...
            icon: '<img class ="imgicon" src="images/weather.jpeg" style="width:1.2em;height: 1.2em; margin-top:4px">',
            title: 'Show weather',
            onClick: function (btn, map) {
                $("#Modal1").modal("show");
            }
    ...
    var timezoneBtn = L.easyButton({
        states: [{
            ...
            icon: '<img class ="imgicon" src="images/timezone.jpeg" style="width:1.2em;height: 1.2em; margin-top:4px">',
            title: 'timezone',
            onClick: function (btn, map) {
                $("#Modal2").modal("show");
            }
    ...
    var imagesBtn = L.easyButton({
        states: [{
            stateName: 'fa-images',
            icon: '<img class ="imgicon" src="images/gallery.jpeg" style="width:1.2em;height: 1.2em; margin-top:4px">',
    ...
    var currncyBtn = L.easyButton({
        states: [{
            ...
            icon: '<img class ="imgicon" src="images/currency.jpeg" style="width:1.2em;height: 1.2em; margin-top:4px">',
